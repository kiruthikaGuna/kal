...
export class TransportDetailsComponent implements OnInit {
  ...
  table1value = [
    {
      no: '1', VehicletNo: '34', Bag: 'bag1', Barcode: '7676656', ArrivedWeight: '40',
      BagWeight: '6' ,  Product: 'colves'
    },
    {
      no: '2', Bag: 'bag2', Barcode: '7676656', VehicletNo: '34', ArrivedWeight: '40',
      BagWeight: '6' , Product: 'colves'
    },
    {
      no: '3', Bag: 'bag3', Barcode: '7676656', VehicletNo: '34', ArrivedWeight: '40',
      BagWeight: '6' ,  Product: 'colves'
    },
  ];
